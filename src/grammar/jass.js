...
let ParserRules = [
    ...
    {"name": "unary_op$subexpression$1", "symbols": [{"literal":"+"}]},
    {"name": "unary_op$subexpression$1", "symbols": [{"literal":"-"}]},
    {"name": "unary_op", "symbols": ["unary_op$subexpression$1", "_", "_expr"], "postprocess": e().flat().reorder(0, 2).kind('unary_op')},
    {"name": "unary_op$string$1", "symbols": [{"literal":"n"}, {"literal":"o"}, {"literal":"t"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "unary_op", "symbols": ["unary_op$string$1", "__", "_expr"], "postprocess": e().flat().reorder(0, 2).kind('unary_op')},
    {"name": "unary_op$string$2", "symbols": [{"literal":"n"}, {"literal":"o"}, {"literal":"t"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "unary_op", "symbols": ["unary_op$string$2", "left_expr"], "postprocess": e().flat().reorder(0, 1).kind('unary_op')},
    {"name": "left_unary_op$subexpression$1", "symbols": [{"literal":"+"}]},
    {"name": "left_unary_op$subexpression$1", "symbols": [{"literal":"-"}]},
    {"name": "left_unary_op", "symbols": ["left_unary_op$subexpression$1", "_", "left_expr"], "postprocess": e().flat().reorder(0, 2).kind('unary_op')},
    {"name": "left_unary_op$string$1", "symbols": [{"literal":"n"}, {"literal":"o"}, {"literal":"t"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "left_unary_op", "symbols": ["left_unary_op$string$1", "__", "left_expr"], "postprocess": e().flat().reorder(0, 2).kind('unary_op')},
    {"name": "left_unary_op$string$2", "symbols": [{"literal":"n"}, {"literal":"o"}, {"literal":"t"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "left_unary_op", "symbols": ["left_unary_op$string$2", "left_right_expr"], "postprocess": e().flat().reorder(0, 1).kind('unary_op')},
