...
let ParserRules = [
    ...
    {"name": "program_blocks", "symbols": ["_program_block"], "postprocess": e().flat().reorder(1)},
    ...
    {"name": "type_declr", "symbols": ["type_declr$string$1", "__", "name", "__", "type_declr$string$2", "__", "name", "newline"], "postprocess": e().flat().reorder(2, 6, 7).kind('type').commentable()},
